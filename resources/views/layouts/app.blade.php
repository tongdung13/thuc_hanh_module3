...
<!--Google Fonts-->
<link href='{{ asset('//fonts.googleapis.com/css?family=Carrois+Gothic') }}' rel='stylesheet' type='text/css'>
<link href='{{ asset('//fonts.googleapis.com/css?family=Work+Sans:400,500,600') }}' rel='stylesheet' type='text/css'>
<!--static chart-->
<script src="{{ asset('backend/js/Chart.min.js') }}"></script>
<!--//charts-->
<!-- geo chart -->
    <script src="{{ asset('//cdn.jsdelivr.net/modernizr/2.8.3/modernizr.min.js') }}" type="text/javascript"></script>
    ...
    <script type="{{ asset('backend/text/javascript') }}">
        jQuery(function ($) {
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="{{ route('manages.index') }}"> <h1>Home</h1>
							...
							<!--search-box-->
								<div class="search-box">
                                    <form method="post" action="{{ route('manages.search') }}" enctype="multipart/form-data">
                                        @csrf
...
<div class="copyrights">
	 <p>© 2020 Tong Dung. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Pages</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		          	 <li id="menu-academico-boletim" ><a href="">Login</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="">Sign Up</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="">City</a></li>
		          </ul>
		        </li>
